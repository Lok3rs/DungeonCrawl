...
public class Ghoul extends Monster {
    ...
    public void move() {
        ...
        if (Math.max(distanceY, distanceX) < 7) {
            ...
            if (distanceX < distanceY && enemyPositionY < this.cell.getY()){
                dy = -1;
            } else if (distanceX < distanceY) {
                dy = 1;
            } else if (distanceY < distanceX && enemyPositionX < this.cell.getX()){
                dx = -1;
            } else if (distanceX == distanceY && enemyPositionX < this.cell.getX()){
                dx = -1;
            } else if (distanceX == distanceY && enemyPositionX > this.cell.getX()){
                dx = 1;
            } else if (distanceY == distanceX && enemyPositionY < this.cell.getY()){
                dy = -1;
            } else {
                dy = 1;
            }
